...
// Attribution: Toyota AE86 by IvOfficial [CC-BY] via Poly Pizza
function CarModel() {
  const { scene } = useGLTF("/assets/toyota.glb");
  ...
  return (
    <group ref={meshRef} dispose={null} scale={[0.5, 0.5, 0.5]} position={[0, 0, 0]}>
    ...
    >
      <Canvas shadows>
        ...
        <Suspense fallback={<Html center>
          <div className="text-white text-xl font-bold tracking-widest uppercase">Loading Nippon...</div>
        </Html>}>
          <CarModel />
